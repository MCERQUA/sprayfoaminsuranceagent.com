...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "spray foam workers comp",
    "spray foam rig insurance",
    "inland marine spray foam",
    "contractors pollution liability spray foam",
  ...
  openGraph: {
    ...
    description:
      "Dedicated spray foam insurance agent — GL, workers' comp, inland marine for rigs and proportioners, contractors pollution liability for isocyanate exposure, and commercial auto. Licensed all 50 states. 15-min quotes.",
  ...
  twitter: {
    ...
    title: `${SITE.name} | Contractors Choice Agency`,
    description:
      "Dedicated spray foam insurance agent — GL, workers' comp, inland marine for rigs, contractors pollution liability, and commercial auto. Personal service, policy review, contractor advocacy. 15-minute quotes.",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const orgSchema = {
    ...
    serviceType: [
      ...
      "Inland Marine & Rig Equipment Coverage",
      "Contractors Pollution Liability for Isocyanate Exposure",
      "Commercial Auto for Spray Foam Contractors",
      "Commercial Umbrella for Spray Foam Operations",
      "Tools & Small Equipment Floater",
      "Spray Foam Insurance Policy Review & Advocacy",
    ],
  };
